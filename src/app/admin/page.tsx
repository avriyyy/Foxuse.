    ...
    const handleChatSearch = async () => {
        ...
        try {
            ...
            if (res.ok) {
                const data = await res.json();
                setChatResults(data);
                showToast(`✅ Found ${data.summary.found}/${data.summary.total}`, 'success');
            } else {
                                ...
                                <div className="mt-6 space-y-4">
                                    <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                                        ...
                                        <div className="grid grid-cols-3 gap-4 text-center">
                                            <div>
                                                <div className="text-2xl font-black">{chatResults.summary.total}</div>
                                                <div className="text-xs text-zinc-600">Total Searched</div>
                                            </div>
                                            <div>
                                                <div className="text-2xl font-black text-green-600">{chatResults.summary.found}</div>
                                                <div className="text-xs text-zinc-600">Found</div>
                                            </div>
                                            <div>
                                                <div className="text-2xl font-black text-red-600">{chatResults.summary.notFound}</div>
                                        ...
                                        <Card key={idx} className="p-4">
                                            <div className="flex items-center justify-between mb-3">
                                                ...
                                                <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                                                    ...
                                                    {result.found ? `✅ ${result.messageCount} messages` : '❌ Not Found'}
                                                </span>
                                            </div>
